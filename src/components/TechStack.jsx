          ...
          <div className="rounded-2xl p-6 cursor-pointer bg-white/0 backdrop-blur-sm shadow-lg card-shake transition-all duration-300 flex flex-col items-center">
            ...
            <span
              className={`
                ...
                ${index % 3 === 0 ? "bg-cyan-900/90 text-cyan-200 shadow-cyan-400/20" : ""}
                ${index % 3 === 1 ? "bg-fuchsia-900/90 text-fuchsia-200 shadow-fuchsia-400/20" : ""}
                ${index % 3 === 2 ? "bg-blue-900/90 text-blue-200 shadow-blue-400/20" : ""}
              `}
              style={{ top: "4.5rem" }}
            >
              {tech.name}
